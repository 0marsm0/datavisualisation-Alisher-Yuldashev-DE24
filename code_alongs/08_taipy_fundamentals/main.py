    ...
    with tgb.part(class_name="container card"):
        with tgb.layout(columns="1 1 1"):
            with tgb.part() as column_fruit:
                ...
                tgb.text("Slider value is {slider_value}")
            ...
            with tgb.part() as column_calculator:
                ...
                tgb.text("You have typed in number {number1} and number {number2}")

                tgb.button(
                    label="CALCULATU", class_name="plain", on_action=perform_calculation
                )
